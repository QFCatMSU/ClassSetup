...
![RStudio Terminal tab (don't forget to check the Project Folder)](images/RStudioTerminalAndProject.png){#fig-RStudioTermProj .fs alt="RStudio Terminal tab (don't forget to check the Project Folder)"}
...
![Changing Git username and email using the Terminal tab](images/GH_EmailAndUsername.png){#fig-terminalTab .fs alt="Changing Git username and email using the Terminal tab"}
...
::: {#fig-testGitConfig}
``` {.bash tab="Terminal"}
$ git config user.name  belinskyc   $ git config user.email  belinsky@msu.edu
```
...
![The Git tab has been added to the RStudio Project](images/GH_02_GitTab.png){#fig-GitTab .fs alt="The Git tab has been added to the RStudio Project"}
...
![Creating a new repository on GitHub](images/GH_CreateRepo.png){#fig-GitURL .fs alt="Creating a new repository on GitHub"}
...
![The URL of your GitHub repository](images/GH_RepoUrl.png){#fig-GitHubURL .fs alt="The URL of your GitHub repository"}
...
``` bash
git add -A git commit -m "A message about the changes to your project" git push -u origin main
```
...
![GitHub asking for authentication](images/GitHubLogin-new.png){#fig-GitHubAuth .fs alt="GitHub asking for authentication"}
...
![The Authentication Successful window](images/GH_Repo_AuthSuccess.jpg){#fig-authSuccess .fs alt="The Authentication Successful window"}
...
![GitHub after a new Commit was pushed](images/GH_First%20Push.png){#fig-GitHubPostCommit .fs alt="GitHub after a new Commit was pushed"}
...
``` bash
git add -A git commit -m "Finished lesson 1b application" git push -u origin main
```
...
![Creating an Issue in GitHub](images/GitHubIssues.png "flexer=true"){#fig-GitHubIssue .fs alt="Creating an Issue in GitHub" grrr="true"}

### Questions to answer {data-link="Questions to answer"}
...
## Extension: Use Git Tab {data-link="Extension: Use Git Tab"}
...
![Using the Git tab to sync with your Github repository](images/GH_UsingGitTab.png){#fig-usingGitTab .fs alt="Using the Git tab to sync with your Github repository"}
