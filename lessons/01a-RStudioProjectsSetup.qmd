...
-   GGPlot version... need to remove reference to GGPlot class if used in other classes.
...
![Executing the whole the script (Source)](images/RSProj_Source.png){#fig-source .fs alt="Executing the whole the script (Source)"}
...
![Cleaning out the panes](images/RSProj_CleanWindows.png){#fig-cleanTabs .fs alt="Cleaning out the panes"}
...
![RStudio looking for packages needed by the script-- click Install and RStudio installs the required package(s)](images/RSProj_InstallPackages.png){#fig-RStudioInstall .fs alt="RStudio looking for packages needed by the script-- click Install and RStudio installs the required package(s)"}
